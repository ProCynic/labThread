...
public class DemoScheduler2{
  ...
  public DemoScheduler2(NWScheduler sched, int nThreads, int bytesToSendPerThread)
  {
    int ii;
    stats = new Stats();
    ...
    source = new Source2(nThreads, bytesToSendPerThread, sched, 
